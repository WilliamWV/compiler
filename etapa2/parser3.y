...
expression: arithmeticExpression | logicExpression | booleanIdentifierExpression;
...
booleanExpression:
	...
	| booleanParenthesisOrOperand booleanOperator booleanIdentifierExpression
	| booleanParenthesisOrOperand booleanOperator TK_IDENTIFICADOR
	| booleanParenthesisOrOperand booleanOperator generalIdentifier
...
booleanIdentifierExpression:
	booleanIdentifierParenthesisOrOperand booleanOperator booleanExpression
	| generalIdentifier booleanOperator booleanExpression

	| booleanIdentifierParenthesisOrOperand booleanOperator booleanIdentifierExpression
	| generalIdentifier booleanOperator booleanIdentifierExpression

	| TK_IDENTIFICADOR booleanOperator booleanExpression
	| TK_IDENTIFICADOR booleanOperator booleanIdentifierExpression
	| TK_IDENTIFICADOR booleanOperator TK_IDENTIFICADOR
	| booleanIdentifierParenthesisOrOperand;
booleanIdentifierParenthesisOrOperand:
	'(' booleanIdentifierExpression ')'
	| '!' '(' booleanIdentifierExpression ')'
	| '!' generalIdentifier;

/*faltou ajeitar as expressoes aritmeticas */
